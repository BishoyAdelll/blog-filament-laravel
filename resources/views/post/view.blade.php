<x-app-layout :meta-title="$post->meta_title ?: $post->title"  :meta-title="$post->meta_description">
                ...
                <div class="bg-white flex flex-col justify-start p-6">
                   <div class="flex gap-4">
                    ...
                    <p href="#" class="text-sm pb-8">
                        By <a href="#" class="font-semibold hover:text-gray-800">{{ $post->user->name }} </a>, Published on {{ $post->getFormaredDate() }}
                    </p>
                   <div>
                    {!! $post->body !!}
                   </div>
